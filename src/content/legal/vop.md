...
> DIČ: 1234567890
> IČ DPH: [DOPLNIŤ]
> Zapísaná v Obchodnom registri Okresného súdu [DOPLNIŤ], oddiel [DOPLNIŤ], vložka č. [DOPLNIŤ]
> E-mail: info@elektronickapodatelna.sk
> Kontakt pre ochranu osobných údajov (DPO): dpo@elektronickapodatelna.sk
>
...
1.4. Služba je určená výlučne pre podnikateľské subjekty (B2B). Služba nie je určená spotrebiteľom v zmysle § 2 písm. a) zákona č. 250/2007 Z. z. o ochrane spotrebiteľa.
...
- b) prijímanie elektronických faktúr a dobropisov vo formáte UBL/XML;
- c) sprístupnenie prijatých dokumentov v užívateľskom rozhraní;
- d) zasielanie e-mailových notifikácií o nových dokumentoch;
- e) viacero používateľských rolí v rámci spoločnosti Zákazníka;
- f) prepojenie viacerých spoločností pod jedným správcovským účtom;
- g) auditný záznam operácií.

2.3. Služba **NEZAHŔŇA**:

- a) **dlhodobú archiváciu prijatých dokumentov** v zmysle zákona č. 431/2002 Z. z. o účtovníctve. Zákazník je výlučne zodpovedný za stiahnutie a archiváciu prijatých dokumentov v súlade s platnými právnymi predpismi (najmä uchovávanie účtovných dokladov po dobu 10 rokov);
- b) účtovné spracovanie dokumentov;
- c) daňové poradenstvo;
- d) odosielanie elektronických faktúr (Služba je primárne určená na prijímanie).

2.4. Služba je poskytovaná „tak, ako je" (as-is) bez záruky neprerušenej dostupnosti. Poskytovateľ vyvíja primerané úsilie na zabezpečenie funkčnosti Služby, avšak neposkytuje žiadnu zmluvnú garanciu úrovne služieb (SLA).
...
- b) stiahne tieto VOP a Zásady ochrany osobných údajov v plnom znení;
- c) výslovne potvrdí súhlas s VOP a Zásadami ochrany osobných údajov;
- d) dokončí aktiváciu spoločnosti na sieti Peppol.

3.2. Stiahnutie VOP a Zásad ochrany osobných údajov je technickou podmienkou aktivácie. Bez stiahnutia oboch dokumentov nie je možné aktiváciu dokončiť.
...
4.1. Služba je spoplatnená **za každý prijatý dokument** podľa cenníka Poskytovateľa platného v čase prijatia dokumentu.
...
- b) za každý prijatý dokument sa z peňaženky odpočíta príslušná suma podľa aktuálneho cenníka;
- c) ak nie je v peňaženke dostatočný zostatok, dokumenty budú dočasne uzamknuté až do dobitia.

4.3. **Ceny sú uvedené v EUR vrátane DPH** vo výške 23 % v zmysle zákona č. 222/2004 Z. z. o dani z pridanej hodnoty.

4.4. **Aktuálny cenník** je dostupný v užívateľskom rozhraní Služby a na webovej stránke peppolbox.sk.

4.5. **Zmena cien.** Poskytovateľ je oprávnený zmeniť cenník. Zmena ceny sa Zákazníkovi oznámi e-mailom najmenej **30 dní** pred jej účinnosťou. Ak Zákazník so zmenou nesúhlasí, je oprávnený ukončiť zmluvný vzťah a požiadať o vrátenie nespotrebovaného zostatku peňaženky podľa článku 6 týchto VOP.

4.6. Zmena ceny sa nevzťahuje na dokumenty prijaté pred dňom účinnosti zmeny.
...
- a) Zákazník zašle písomnú žiadosť o refundáciu na e-mail info@elektronickapodatelna.sk;
...
6.7. Po refundácii a deaktivácii účtu sa všetky osobné údaje a obchodné dokumenty Zákazníka spracúvajú v súlade so Zásadami ochrany osobných údajov (najmä článkom o uchovávaní údajov).
...
- c) **pravidelne sťahovať a archivovať prijaté dokumenty** v súlade s povinnosťou uchovávania účtovných dokladov podľa zákona č. 431/2002 Z. z. o účtovníctve a iných platných predpisov;
- d) uhrádzať poplatky za Službu v súlade s týmito VOP;
- e) nezneužívať Službu na nezákonné účely;
- f) bezodkladne nahlásiť Poskytovateľovi akékoľvek bezpečnostné incidenty alebo neoprávnené použitie účtu.

7.2. Zákazník výslovne berie na vedomie a súhlasí s tým, že **Poskytovateľ neposkytuje dlhodobú archiváciu** prijatých dokumentov a Zákazník nesie plnú zodpovednosť za uchovávanie dokumentov pre účely účtovníctva, daní a kontrolných orgánov.
...
8.1. Poskytovateľ vyvíja primerané úsilie pri prevádzke Služby, avšak neposkytuje žiadne výslovné ani implicitné záruky ohľadom dostupnosti, presnosti, spoľahlivosti, vhodnosti na konkrétny účel alebo neporušenia práv tretích strán.

8.2. **Maximálna celková zodpovednosť Poskytovateľa** voči Zákazníkovi za škody vzniknuté v súvislosti so Službou (zo všetkých nárokov dohromady, vrátane zmluvnej zodpovednosti, deliktnej zodpovednosti, porušenia záruk alebo akýchkoľvek iných nárokov) **je obmedzená na sumu 100,00 EUR**.

8.3. Poskytovateľ nezodpovedá za:

- a) škody vzniknuté v dôsledku **straty alebo vymazania dokumentov**, ktoré si Zákazník nestiahol a nearchivoval;
- b) škody vzniknuté v dôsledku výpadku alebo nedostupnosti siete Peppol, prístupového bodu (Access Point) ion-AP alebo iných tretích strán;
- c) škody vzniknuté v dôsledku výpadku platobných systémov (NOP, banky, atď.);
- d) škody vzniknuté v dôsledku nezákonného alebo neautorizovaného použitia Služby;
- e) ušlý zisk, nepriame, následné alebo špeciálne škody;
- f) chyby v obsahu prijatých faktúr alebo iných dokumentov (Poskytovateľ je len doručovateľom, nie obsahovým spracovateľom);
- g) škody spôsobené zásahom vyššej moci (vis maior).
...
9.1. Spracúvanie osobných údajov sa riadi samostatným dokumentom **„Zásady ochrany osobných údajov"** dostupným na webovej stránke peppolbox.sk.
...
10.1. Poskytovateľ posiela Zákazníkovi výlučne **transakčné e-maily**, najmä:
...
10.2. Poskytovateľ **neposiela marketingové ani propagačné e-maily.** Vzhľadom na výlučne transakčný charakter komunikácie nie je k dispozícii možnosť odhlásenia (unsubscribe).
...
11.2. **Zákazník** je oprávnený kedykoľvek ukončiť zmluvný vzťah písomnou žiadosťou o deaktiváciu účtu zaslanou na info@elektronickapodatelna.sk. Po deaktivácii je zostatok peňaženky vrátený Zákazníkovi v súlade s článkom 6 týchto VOP.

11.3. **Poskytovateľ** je oprávnený ukončiť zmluvný vzťah:
...
13.1. Poskytovateľ je oprávnený jednostranne zmeniť tieto VOP. Zmena je platná zverejnením nového znenia na webovej stránke peppolbox.sk.
